...
def register():
    ...
    question = Label(register_screen, text="Nickname * ",font=("impact", 18),bg="#2283a1")
    ...
    question = Label(register_screen, text="Renter Nickname * ",font=("impact", 18),bg="#2283a1")
...
##                    break
                    ...
                    if str(pwd) == str(morse_pass) : #password
                        ...
                        Label(login_screen, text="Nickname * ",font=("times", 25,"bold"),background="#295a63").place(x = 200,y = 350)
